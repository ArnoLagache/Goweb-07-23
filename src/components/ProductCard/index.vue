		...
		<div class="grid">
			...
			<div class="product-more">				
				...
				<div class="product-more__price">
					...
					<form>
						<div v-if="!price">
							<input type="number" v-model="price" :placeholder="product.price" required /><span class="currency">€</span>
						</div>
						<div v-else>
							<input type="number" v-model="price" :placeholder="price" required /><span class="currency">€</span>
						</div>

						<div class="product-more__price-vat">
							<span>Price&nbsp;</span>
							<span v-if="!vat_price">(including VAT): {{ product.vat_price }}&nbsp;€</span>
